...
class BCQPSolver {
  public:
     ...
     */
    int solveAPGD(const Teuchos::RCP<TV> &xsolRcp, const double tol, const int iteMax,
     ...
     * @return int return error code. 0 for normal execution.
     */
    int solveBBPGD(const Teuchos::RCP<TV> &xsolRcp, const double tol, const int iteMax,
                   IteHistory &history) const;
