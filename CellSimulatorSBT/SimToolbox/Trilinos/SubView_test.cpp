...
void test() {
    ...
    auto vecSubView1Ptr = vecSubView1->getLocalView<Kokkos::HostSpace>(Tpetra::Access::ReadWrite);
    auto vecSubView2Ptr = vecSubView2->getLocalView<Kokkos::HostSpace>(Tpetra::Access::ReadWrite);
