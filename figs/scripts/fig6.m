...
%% Load in images and display
try
  vel50 = resizeVelocity(imread('../snapshots/velocity/nu1.0_L50_6.png'));
  vel100 = resizeVelocity(imread('../snapshots/velocity/nu1.0_L100_7.5.png'));
  vel150 = resizeVelocity(imread('../snapshots/velocity/nu1.0_L150_8.png'));
catch
  vel50 = [];
  vel100 = [];
  vel150 = [];
